...
export const MENU_DATA: MenuItem[] = [
  // 御膳・定食
  { id: "1", name: "特製 すき焼き御膳", description: "厳選和牛を贅沢に使用した当店自慢の逸品。", price: 1800, category: "御膳・定食", imageUrl: "/sukiyakigozenn.jpg", isSoldOut: false },
  { id: "2", name: "季節の刺身盛り合わせ", description: "旬の鮮魚を市場から直接仕入れた新鮮なお造り。", price: 2400, category: "御膳・定食", imageUrl: "/sashimi.jpg", isSoldOut: false },
  { id: "3", name: "極上 海鮮丼", description: "新鮮な海の幸をふんだんに盛り込んだ贅沢な一杯。", price: 2100, category: "御膳・定食", imageUrl: "/kaisenndonn.jpg", isSoldOut: true },
